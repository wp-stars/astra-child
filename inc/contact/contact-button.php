...
namespace Limesoda\Astra_Child\Contact\LS_Contact_Button;
...
add_action('wp_enqueue_scripts', '\Limesoda\Astra_Child\Contact\LS_Contact_Button\enqueue_contact_assets');
